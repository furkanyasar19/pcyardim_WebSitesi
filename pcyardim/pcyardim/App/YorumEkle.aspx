<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="YorumEkle.aspx.cs" Inherits="pcyardim.App.DonanimYorumEkle" %>
            ...
            <div class="row">
                <div class="beyazyer">
                    <div class="col-sm-12">
                        ...
                        <br />
                        <asp:Label ID="lblKonuBaslik" runat="server" CssClass="konuBaslik2" Text=""></asp:Label>
                        <hr />
                    </div>
                    <div class="col-sm-12">
                        <label>Yorum: </label>
